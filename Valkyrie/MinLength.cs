...
namespace Valkyrie
{
    ...
    public sealed class MinLengthAttribute(long value, string errorMessage = "")
        : ValidationAttribute(string.IsNullOrEmpty(errorMessage) ? "{0} is shorter than {1}" : errorMessage)
    {
        /// <summary>
        /// Value to compare to
        /// </summary>
